...
//Stucture 
export { ReactComponent as IconProfile2person  } from './structure/profile-2user.svg';
export { ReactComponent as IconStructureAdmin  } from './structure/avatar-img.svg';
export { ReactComponent as Icondownward  } from './structure/downward.svg';
