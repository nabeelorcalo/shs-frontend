                            ...
                            <>
                                <Col xxl={12} xl={12} lg={12} md={24} sm={24} xs={24}>
                                    <div className='details'>
                                        <Typography
                                            className='text-primary-color font-normal text-base'>{
                                                item.title}
                                        </Typography>
                                        <Typography
                                            className='text-primary-color font-normal text-base'>
                ...
                <div className='mt-3'>
                    <center>
                        ...
                        <div className='p-6 mt-3 mb-4'>
                            ...
                            <Typography className='text-[#000000] font-normal text-sm mb-4'>Your request to withdraw $1000 has been successfully sent. You will be notified as soon as it is approved.
                                Transaction ID: TRX2MGNVHSEZR</Typography>
                            <Button onClick={() => {
                                props.setShow(false);
                            }}
