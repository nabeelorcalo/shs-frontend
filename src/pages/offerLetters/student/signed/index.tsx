...
const tempArray = [
  { name: "Power Source" },
  { name: " Offer Letters ", onClickNavigateTo: `/${ROUTES_CONSTANTS.OFFER_LETTER}` },
];

const SignedOfferLetter = () => {
  return (
      ...
      <BoxWrapper>
        <Row gutter={[0, 30]}>
          <Col xxl={24} xl={24} lg={24} md={24} sm={24} xs={24}>
            <div className="flex gap-4  p-6 rounded-[8px] items-center">
...
export default SignedOfferLetter;
