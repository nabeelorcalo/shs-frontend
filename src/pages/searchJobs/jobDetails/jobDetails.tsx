      ...
      <BoxWrapper>
        ...
        <div>
          ...
          <p className="my-3">
            ...
            all 50 states and over 200 employees. The Software Engineering Team
            is currently in the next stage of growth, with 5 roles available -
            this role is seeking experts in React & Javascript. As part of the
            Frontend team, you will participate in shaping services, driving
            performance and managing activity for customers. As they continue to
            grow, add products and services you will be key to helping define,
            design, and develop that vision.
          </p>
          ...
          <ul className="my-3">
            <li>
              ...
              documentation.
              <li>
                Deliver high-quality, scalable and heavily tested software that
                is modular, secure, reliable and usable.
              </li>
              <li>
                Take ownership of our product stacks and make continuous
                improvements and provide necessary operational support whenever
                needed.
              </li>
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              practices and tools, including SQL databases, caching strategies,
              backend APIs, Node.js, MongoDB, and JSON
            </li>
            <li>
              Strong competencies in system design, data structures, algorithms
              and problem-solving.
            </li>
