              ...
              <div className='p-4'>
                      ...
                      <Row gutter={[15,15]}>
                          ...
                          <Form.Item
                              ...
                              >
                              <Input placeholder='University of Lincoln' className='input-style'/>
                          ...
                          <Form.Item
                                  ...
                                  rules={[{ required: true }, { type: "string" }]}>
                          <Space.Compact>
      <Select defaultValue="+91" options={options} style={{ width: '25%' }} className='input-style'/>
      <Input defaultValue="xxxxx-xxxxxx" style={{ width: '75%' }} className='input-style' />
    </Space.Compact>
                    ...
                    />
                      ...
                      <Row>
                          ...
                          <TextArea rows={4} placeholder="Write something about the university..." maxLength={6} className='input-style'/>
                              </Form.Item>
                          </Col>
                      </Row>
                      <div className='flex items-center justify-center md:justify-end pt-3'>
                          ...
                          <Button className='btn-save'  htmlType="submit">Save</Button>
                          </Space>
                      </div>
