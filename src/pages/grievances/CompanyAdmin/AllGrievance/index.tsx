  ...
  return (
    <div className='add-grievance'>
      ...
      <Row gutter={[20,20]}>
        ...
        <Col xxl={18} xl={18} md={24} sm={24} xs={24} className="flex justify-end gap-4 add-grievance-right">
          <Button
            size="middle"
            onClick={() => {
              setShowBlowWhistleModal(!showBlowWhistleModal);
            }}
            className="flex gap-2 blow-whistle-button white-color teriary-bg-color main-btn"
          >
