      ...
      <BoxWrapper>
        <Row gutter={[0, 30]}>
          <Col xxl={24} xl={24} lg={24} md={24} sm={24} xs={24}>
            <div className="flex gap-4 bg-[antiquewhite] p-6 rounded-[8px] items-center">
              <div className="page-header-secondary-bg-color rounded-[50%] flex justify-center items-center w-[20px] h-[20px] text-[white]">
                X
              </div>
              <div>
            ...
            <Row gutter={[10,24]}>
              ...
              <Col xxl={12} xl={12} lg={12} md={24} sm={24} xs={24}>
                <div className="white-bg-color border-2 border-solid border-[#D6D5DF] rounded-[16px] ">
                  ...
                  <div className="flex bg-[antiquewhite] rounded-b-[14px]  p-4 items-center pb-9">
                    <Encryption />
                    <div className="pl-6">
