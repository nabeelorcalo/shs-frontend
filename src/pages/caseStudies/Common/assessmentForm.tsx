...
const AssessmentFormCaseStudies = () => {
  ...
  const tableData = selectedCasStudyData?.map((obj: any) => ({ ...obj, managerRemarks: <ManagerRemarks /> }));
  ...
  //     learningObjectives:
  //       "For accuracy and completeness, developed and rewrote technical documentation known as Market Research Description and Product Requirement Document, which included instructions, broachers, product catalogues, and website resources.",
  //     evidenceOfProgress:
  //       "Collected and documented information on integration issues and vulnerabilities, as well as suggestions for improvement. Using Visual Studio, created accurate and efficient test scripts for automated testing of certain products and features.",
  ...
  //     evidenceOfProgress:
  //       "Since we started working in the office. This has exposed me to a working atmosphere, which is the first stage in my personal development. And I'm transitioning from a teaching setting to an office setting.",
  //     managerRemarks: <ManagerRemarks />,
  //   },
  //   {
  //     learningCategories: "Working with Others",
  ...
  //     evidenceOfProgress:
  //       "Being proactive about the duties and accomplishing them on time was difficult at first, but with practice and superior performance, it is possible.",
  //     managerRemarks: <ManagerRemarks />,
  //   },
  //   {
  ...
  //     evidenceOfProgress:
  //       "Developed and wrote Market Research Description and Product Requirement Document, for our Confluence page for different bases for our projects which comprised instructions, broachers, product catalogues, and website resources, was developed and rewritten for correctness and completeness.",
  //     managerRemarks: <ManagerRemarks />,
  //   },
  //   {
  ...
  //     evidenceOfProgress:
  //       "As a result of my internship, I've leaned a crucial concept to comprehend and investigate based on the scenario, rather than getting lost in a sea of ideas.",
  //     managerRemarks: <ManagerRemarks />,
  //   },
  // ];
  return (
    <div className="company-admin-assessment-form">
          ...
          {tableData.map((item: any) => {
            return (
              <div className="mt-5 flex gap-10">
                ...
                <div className="lg:w-[400px]"> {item?.managerRemarks}</div>
              </div>
            );
          })}
      ...
      <SignatureAndUploadModal
        ...
        footer={
          <>
            <Button className="white-bg-color teriary-color font-semibold assessment-form-signature-modal-cancel-btn">
              Cancel
            </Button>
            ,
            <Button
