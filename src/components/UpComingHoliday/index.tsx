          ...
          <li key={data.id} className='List_item_wrapper'>
            <div className='List_item_main flex items-center justify-between '>
              <div className='left_side'>
                <p className='light_text text-sm font-norma '>{action.formate(data.date,"dddd")}</p>
                <p className='date_text text-base font-normal'>{action.formate(data.date,"D-MMMM").replace(/-/g, ' ') }</p>
              </div>
