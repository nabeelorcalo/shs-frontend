...
export const DragAndDropUpload = () => {
  ...
  return (
    <>
      <div onDragOver={handleDragOver} onDrop={handleDropped} className="flex flex-col items-stretch justify-center gap-4 content-center items-center   drag-drop-upload-style">
